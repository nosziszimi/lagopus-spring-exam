...
As it can have abstract and non abstract methodes, I would use it in the case when I want generalise functions which should work little differently after the class is extended.
